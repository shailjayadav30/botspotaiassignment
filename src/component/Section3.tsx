...
const Section3 = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row w-full bg-gray-100 p-8 rounded-lg shadow-lg">
      <div className="w-full sm:w-[50%] overflow-x-auto mb-8 sm:mb-0 sm:mr-8">
        <table className="w-full table-auto text-center border-collapse rounded-lg overflow-hidden shadow-md">
          <thead>
            <tr className="bg-gray-200 text-gray-700">
              ...
              <th className="p-4 border-b border-gray-300">Price/sq.ft</th>
              <th className="p-4 border-b border-gray-300">Growth %</th>
            </tr>
          </thead>
          <tbody>
            {items.map((item, index) => (
              ...
              >
                <td className="p-4 border-b border-gray-200">{item.location}</td>
                <td className="p-4 border-b border-gray-200">{item.price}</td>
                <td className="p-4 border-b border-gray-200">{item.growth}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="w-full sm:w-[50%] flex justify-center items-center">
        <img
          className="w-full h-[24.5rem] object-cover rounded-lg shadow-lg"
          src={map}
          alt="Map"
        />
      </div>
